      ...
      <div className="mission-card">
        ...
        <div className="mission-copy">
          ...
          <div className="mission-actions">
            ...
            <button className="primary" onClick={() => onContinue && onContinue(choice)}>Continue</button>
          </div>
        </div>
      </div>
    </div>
...
export function EarthFacts({ player, onBack, onLaunch }) {
  const [showCrater, setShowCrater] = React.useState(false)
        ...
        <div className="facts-copy">
          ...
          {!showCrater ? (
            <div className="facts-actions">
              <button className="primary" onClick={() => setShowCrater(true)}>Continue</button>
