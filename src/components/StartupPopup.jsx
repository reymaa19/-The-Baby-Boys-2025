...
const StartupPopup = ({ onStart }) => {
  ...
  const containerStyle = {
    ...
    animation:
      impactPhase === "explosion" ? "screenShake 1s ease-in-out" : "none",
  ...
  const earthStyle = {
    ...
    animation:
      impactPhase === "explosion"
        ? "earthDestruction 2s ease-in forwards"
        : "none",
  ...
  const asteroidStyle = {
    ...
    animation:
      impactPhase === "impact"
        ? "asteroidRealImpact 15s linear forwards"
        : "none",
    opacity:
      impactPhase === "miniExplosion" || impactPhase === "explosion" ? 0 : 1,
    transition: "opacity 1s ease-out",
  };
  ...
  const title2Style = {
    ...
    textShadow:
      "0 0 15px rgba(255, 107, 53, 1), 0 0 30px rgba(255, 107, 53, 0.8), 0 0 45px rgba(255, 107, 53, 0.6), 0 0 60px rgba(255, 107, 53, 0.4)",
    fontFamily: "Arial Black, Arial, sans-serif",
  ...
  const buttonStyle = {
    ...
    cursor: "pointer",
    boxShadow:
      "0 10px 30px rgba(255, 107, 53, 0.4), inset 0 2px 10px rgba(255, 255, 255, 0.2)",
  ...
  return (
    ...
    >
      <div style={backgroundStyle}>
        {/* Stars */}
        <div style={starsContainerStyle}>{generateStars()}</div>
        ...
        <div style={asteroidStyle}>
          ...
          <div
            style={{
              ...
              height: "28px",
              background:
                "radial-gradient(ellipse at 30% 30%, #111 0%, #222 50%, #333 100%)",
              borderRadius: "60% 40% 50% 70%",
              boxShadow:
                "inset -8px -8px 15px rgba(0, 0, 0, 0.9), inset 2px 2px 5px rgba(100, 100, 100, 0.1)",
            }}
          />
          {/* Medium crater */}
          <div
            style={{
              ...
              height: "20px",
              background:
                "radial-gradient(ellipse at 40% 40%, #111 0%, #222 60%, #333 100%)",
              borderRadius: "50% 60% 40% 80%",
              boxShadow:
                "inset -6px -6px 12px rgba(0, 0, 0, 0.9), inset 1px 1px 3px rgba(80, 80, 80, 0.1)",
            }}
          />
          {/* Small crater */}
          <div
            style={{
              ...
              height: "15px",
              background:
                "radial-gradient(ellipse at 35% 35%, #0a0a0a 0%, #1a1a1a 50%, #2a2a2a 100%)",
          ...
          <div
            style={{
              ...
              height: "10px",
              background:
                "radial-gradient(ellipse at 30% 30%, #000 0%, #111 40%, #222 100%)",
              borderRadius: "50%",
        ...
        {impactPhase === "miniExplosion" && (
          <div
            style={{
              ...
              height: "80px",
              background:
                "radial-gradient(circle, #ffffff 0%, #ffff00 20%, #ff8c00 50%, #ff4500 80%, transparent 100%)",
              borderRadius: "50%",
          ...
          <>
            ...
            <div
              style={{
                ...
                height: "200px",
                background:
                  "radial-gradient(circle, #ffffff 0%, #ffff00 10%, #ff8c00 25%, #ff4500 45%, #ff0000 70%, #8b0000 90%, transparent 100%)",
                borderRadius: "50%",
            ...
            <div
              style={{
                ...
                height: "300px",
                background:
                  "radial-gradient(circle, transparent 30%, #ff8c00 40%, #ff4500 50%, #ff0000 65%, transparent 80%)",
                borderRadius: "50%",
            ...
            <div
              style={{
                ...
                height: "400px",
                background:
                  "radial-gradient(circle, transparent 40%, rgba(255, 100, 0, 0.6) 50%, rgba(255, 0, 0, 0.4) 70%, transparent 80%)",
                borderRadius: "50%",
            ...
            {Array.from({ length: 12 }).map((_, i) => (
              <div
                ...
                style={{
                  ...
                  background:
                    "linear-gradient(to top, #ff0000, #ff8c00, #ffff00, #ffffff, transparent)",
            ...
            <div
              style={{
                ...
                height: "100vh",
                background:
                  "radial-gradient(circle at 85% 85%, rgba(255,255,255,0.95) 0%, rgba(255,200,0,0.8) 20%, rgba(255,100,0,0.6) 40%, rgba(255,50,0,0.3) 70%, transparent 100%)",
      ...
      <div style={contentStyle}>
        ...
        <motion.button
          ...
          whileHover={{
            scale: 1.1,
            boxShadow:
              "0 15px 40px rgba(255, 107, 53, 0.6), inset 0 2px 10px rgba(255, 255, 255, 0.3)",
          }}
          whileTap={{ scale: 0.95 }}
        >
          PLAY
